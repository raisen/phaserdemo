module MyGame {
    ...
    export class Level2 extends Level {
        ...
        create() {
            ...
            var ledge1 = this.platforms.create(300, 300, KEYS.ground);

            ledge1.body.immovable = true;

            var ledge2 = this.platforms.create(-150, 450, KEYS.ground);
            ...
            new Enemy(this.game, this.game.world.width / 2 + 20, this.ground.y - this.ground.height, this.enemies);
            ...
            new Enemy(this.game, ledge2.x + ledge2.width - 20, ledge2.y - ledge2.height, this.enemies);
